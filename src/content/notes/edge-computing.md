---
title: "边缘计算基本概念"
summary: "理解边缘计算的低延迟、本地处理、带宽优化、可靠性和隐私边界。"
type: "concept"
tags: ["边缘计算", "本地处理", "低延迟", "分布式"]
related: ["车载边缘计算", "边缘智能", "云边协同"]
order: 30
---

**边缘计算（Edge Computing）** 是一种分布式计算架构，它将数据处理从中心化的数据中心推向网络的边缘，即数据产生的地方。与传统云计算相比，边缘计算的核心价值是减少数据传输距离和延迟，使数据能够在接近数据源的地方实时处理和分析。

<section class="knowledge-visual edge-loop">
  <div>
    <span>数据源</span>
    <strong>传感器 / 设备 / 车辆 / 摄像头</strong>
  </div>
  <i></i>
  <div>
    <span>边缘节点</span>
    <strong>过滤 / 推理 / 规则 / 缓存</strong>
  </div>
  <i></i>
  <div>
    <span>云端</span>
    <strong>训练 / 分析 / 编排 / 长期存储</strong>
  </div>
</section>
